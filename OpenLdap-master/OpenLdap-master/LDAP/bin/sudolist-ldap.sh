#!/bin/bash
#
# Script para enlistar perfiles SUDO en el directorio LDAP
#
...
echo ""
echo "Lista de perfiles SUDO creados en el directorio. Base: ou=sudoers,$searchbase"
echo ""
ldapsearch -x -b ou=sudoers,$searchbase -D $binduser -w $bindpass dn|grep "cn="
echo ""
