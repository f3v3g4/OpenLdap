#!/bin/bash
#
# Script para agregar un LDIFF en el directorio LDAP - Modo MODIFY
#
...
case $2 in
        ...
        ;;
        *)
        echo -n "Desea agregar el LDIFF de modificacion \"$1\" ? [y/n]:"
        read -n 1 answer
        echo ""
        ;;
esac
...
"y"|"Y")
	echo ""
	echo "Agregando $1 al directorio LDAP en modo MODIFY"
	echo ""
	;;
*)
	echo ""
...
then
	...
	echo "ALERTA ALERTA !!. El dn \"$mydnis\" no existe en el directorio LDAP"
...
if [ $realmodify == 0 ]
then
	echo "ALERTA: El archivo no es para un MODIFY de LDAP"
	echo "abortando el resto de la operacion"
	echo ""
	exit 0
fi
