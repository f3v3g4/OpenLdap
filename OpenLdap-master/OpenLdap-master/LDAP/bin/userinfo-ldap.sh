#!/bin/bash
#
# Script para mostrar informacion de un usuario en el directorio LDAP
#
...
echo ""
echo "Informacion para el usuario $account"
echo ""

usergid=`getusergidnumber $account`
usergroupname=`getgroupcn $usergid`

echo "El usuario pertenece al grupo de nombre: \"$usergroupname\""
echo ""
